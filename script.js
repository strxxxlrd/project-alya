...
const translations = {
    uk: {
        ...
        'project-03-solution-mobile': 'Обрано вінтажну стилістику, що<br /> відображає характер клубу та створює<br /> відчуття історії й спільноти. Структура<br /> сайту включає: про клуб, команду,<br /> історію, запис натренування та розділ<br /> з фірмовим мерчем',
        ...
        'project-03-result-mobile': 'Зрозумілий багатосторінковий сайт,<br /> якийпоєднує презентацію бренду клубу<br /> та зручну взаємодію з користувачем',
